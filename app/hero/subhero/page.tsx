...
const SubPage = () => {
  ...
  <div className="container px-5 py-5 mx-auto">
    ...
    initial="hidden"
    whileInView="show"
    className="flex flex-wrap -m-4 overflow-hidden">
    {products.map(product => (
      <motion.div variants={images} key={product.id} className="lg:w-1/4 md:w-1/2 p-4 w-full">
